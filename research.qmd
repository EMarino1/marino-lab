...
## Building materials from nanoparticles: from components to emergence

Over the past decades, researchers have learned how to synthesize nanoparticles with an extraordinary diversity of sizes, shapes, and compositions, spanning much of the periodic table. Each of these building blocks comes with its own set of physical properties.

Our lab asks a simple but powerful question: **what happens when these nanoparticles are combined into larger, organized structures?**

In particular, we are interested in whether self-assembly can be used to create materials with **emergent properties**: properties that do not exist in the individual components, but arise *only* when they are brought together in a precise way.

Our long-term goal is to understand and harness these effects to design new materials that can help address major challenges in energy, climate, and sustainability.
...
![](images/research/structure-understand-v2.png){fig-align="center" width="75%"}
...
![](images/research/light-matter-v2.png){fig-align="center" width="100%"}
...
![](images/research/reconfigurable.png){fig-align="center" width="75%"}
